...
if __name__ == "__main__":
    ...
    magnitude = sp = fft(audioData)  ############# transformmmmm



    magnitude = band_filter_in_frequency(magnitude, 580, 10000)



    audioData = ifft(magnitude).real ########### inverseeeeeeeeeeeee



    plt_time_domain(sampleRate, audioData, 'Time Domain Representation after band-pass filter')
    #print(audioData[6000:2000])
